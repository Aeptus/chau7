...
enum FeatureMetric: String, CaseIterable, Identifiable {
    ...
    case terminalPoll = "Poll"
    case metalDrawStage = "Metal Draw"
    case tripleBufferSync = "Triple Sync"
    case tripleBufferCommit = "Triple Commit"
    case metalInstanceBuffer = "Instance Buffer"
    case metalGlyphLookup = "Glyph Lookup"
    case highlightDraw = "Highlight"
    case dangerousHighlightRefresh = "Danger Highlight"
    case dangerScan = "Danger Scan"
    case ansiParse = "ANSI Parse"
    case semantic = "Semantic"
    case aiDetect = "AI Detect"
    case debugRefresh = "Debug Refresh"
    case debugAnalyticsRefresh = "Debug Analytics"
    case remoteOutput = "Remote Output"
    case restorePipeline = "Restore"
    ...
    var signpostName: StaticString {
        ...
        case .terminalPoll: return "TerminalPoll"
        case .metalDrawStage: return "MetalDrawStage"
        case .tripleBufferSync: return "TripleBufferSync"
        case .tripleBufferCommit: return "TripleBufferCommit"
        case .metalInstanceBuffer: return "MetalInstanceBuffer"
        case .metalGlyphLookup: return "MetalGlyphLookup"
        case .highlightDraw: return "HighlightDraw"
        case .dangerousHighlightRefresh: return "DangerousHighlightRefresh"
        case .dangerScan: return "DangerScan"
        case .ansiParse: return "AnsiParse"
        case .semantic: return "Semantic"
        case .aiDetect: return "AIDetect"
        case .debugRefresh: return "DebugRefresh"
        case .debugAnalyticsRefresh: return "DebugAnalyticsRefresh"
        case .remoteOutput: return "RemoteOutput"
        case .restorePipeline: return "RestorePipeline"
