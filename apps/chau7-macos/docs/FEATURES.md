...
- Repository-group drags move one layer-backed AppKit snapshot over an invisible stable SwiftUI placeholder; previews and final reorders consume the same deterministic transaction geometry, including neighbor displacement and exact edge-scroll compensation.
