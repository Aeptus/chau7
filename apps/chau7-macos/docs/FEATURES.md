...
| **Background window render backpressure** | Visible selected tabs in non-input-priority windows keep a retained passive surface and drain through the shared background path instead of driving full live Metal sync |
