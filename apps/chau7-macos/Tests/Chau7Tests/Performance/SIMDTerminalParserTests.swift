...
final class SIMDTerminalParserTests: XCTestCase {
    ...
    func testScanFindsAnsiEscape() {
        ...
        XCTAssertTrue(
            result.hasEscapeSequences,
            "Should detect escape sequence"
        )
        XCTAssertEqual(
            result.escapePositions,
            [5],
    ...
    func testIsPrintableASCIIWithPureASCII() {
        ...
        XCTAssertTrue(
            SIMDTerminalParser.isPrintableASCII(bytes.withUnsafeBufferPointer { $0 }),
