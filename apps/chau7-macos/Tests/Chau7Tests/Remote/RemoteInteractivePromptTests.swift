...
final class RemoteInteractivePromptTests: XCTestCase {
    func testCodableRoundTripPreservesContextFields() throws {
        let prompt = RemoteInteractivePrompt(
            ...
            projectName: "Chau7",
            branchName: "main",
            currentDirectory: "/Users/christophehenner/Downloads/Repositories/Chau7",
        ...
        XCTAssertEqual(decoded.currentDirectory, "/Users/christophehenner/Downloads/Repositories/Chau7")
    }
}
