...
| `pillars-card-cognitive` | `<a>` | Lower Cognitive Load card |
| `pillars-card-cost` | `<a>` | Optimize Cost & Context card |
| `pillars-card-control` | `<a>` | Visibility & Control card |
...
## Features Page Registry

| data-ui | Element | Content |
|---------|---------|---------|
| `features-pillar-cognitive` | `<section>` | Lower Cognitive Load pillar with 8 curated feature cards |
| `features-pillar-cost` | `<section>` | Optimize Cost & Context pillar with 6 curated feature cards |
| `features-pillar-control` | `<section>` | Visibility & Control pillar with 8 curated feature cards |

## Feature Detail Pages (77 static pages)

| data-ui | Element | Content |
|---------|---------|---------|
| `feat-hero` | `<section>` | Feature hero with badge, title, and tagline |
| `feat-questions` | `<section>` | "Questions this answers" SEO section |
| `feat-how` | `<section>` | "How it works" + "Why it matters" content |
| `feat-pain` | `<section>` | "The pain this solves" section with code-backed workflow friction bullets |
| `feat-subfeatures` | `<section>` | "What ships with it" section listing sub-features and implementation details |
| `feat-related` | `<section>` | Related features grid (up to 3 cards) |
| `feat-faq` | `<section>` | FAQ accordion |
| `feat-cta` | `<section>` | Download CTA with nudge line |
