...
Chau7/
├── Sources/
│   ├── Chau7/                 # Main application (62 files)
│   │   ├── SettingsViews/     # Settings UI components
│   │   └── Resources/         # Localization files
│   └── Chau7Core/             # Core library (4 files)
│       ├── CommandDetection.swift
│       ├── ShellEscaping.swift
│       ├── SnippetParsing.swift
│       └── ColorParsing.swift
├── Tests/
...
1. **Location**: Add tests to `Tests/Chau7Tests/`
...
1. **English strings**: `Sources/Chau7/Resources/en.lproj/Localizable.strings`
2. **French strings**: `Sources/Chau7/Resources/fr.lproj/Localizable.strings`
...
1. Create `Sources/Chau7/Resources/{lang}.lproj/Localizable.strings`
